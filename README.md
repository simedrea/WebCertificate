...
<html>
	...
	<body class="index">
		<header >
			...
			<div class="button">
				<a href="istoric.html" class="btn"> ISTORIC </a>
				<a href="https://www.youtube.com/watch?v=xPe1jMuX32s" class="btn">  VIDEO   </a>
			</div>
		</header>
	...
	<body class="galerie">
		...
		<div class="istoric">
			...
			<p>
				...
				<span><b><u> Nutriție </u></b> </span>
				<br>
				<br>
				<span> O porție de 100 de grame de ciocolată cu lapte furnizează 540 de calorii. Reprezintă 59% carbohidrați (52% ca zahăr și 3% ca fibră dietetică), 30% grăsimi și 8% proteine. Aproximativ 65% din grăsimea din ciocolata cu lapte este saturată, în principal acid palmitic și acid stearic, în timp ce grăsimea nesaturată predominantă este acidul oleic.
				</span>
				<br>
				<br>
				<span> 100 de grame de ciocolată cu lapte este o sursă excelentă (peste 19% din valoarea zilnică, VZ) de riboflavină, vitamina B12 și minerale dietetice, mangan, fosfor și zinc. Ciocolata este o sursă bună (10–19% VZ) de calciu, magneziu și fier.
				</span>
			...
			<div class="galerie2">
				<table cellspacing="10">
					...
					<tr>
						<td>
							<img src="cioco.jpg">
							<p> Negresă cu ciocolată </p>
						</td>
						<td>
							<img src="cioco2.jpg">
							<p> Înghețată cu Oreo </p>
						</td>
						<td>
							<img src="cioco3.jpg">
							<p> Praline-caramel sărat </p>
						</td>
						<td>
							<img src="cioco4.jpg">
							<p> Brioșe cu ciocolată </p>
						</td>
					</tr>
					...
					<tr>
						<td>
							<img src="cioco5.jpg">
							<p> Fursecuri cu ciocolată </p>
						</td>
						<td>
							<img src="cioco6.jpg">
							<p> Tartă de ciocolată </p>
						</td>
						<td>
							<img src="cioco7.jpg">
							<p> Tort de ciocolată </p>
						</td>
						<td>
							<img src="cioco8.jpg">
							<p> Batoane de ciocolată </p>
						</td>
					</tr>
...
<html>
	...
	<body class="index">
		...
		<div class="ingrediente">
			...
			<h1> INGREDIENTE </h1>
			<br>
			<table cellspacing="12" class="tabl">
				<tr> 
					<td> Ciocolată cu lapte: </td>
					<td> Cacao solidă </td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td></td>
					<td> Lapte praf sau condensat </td>
					<td class="reteta"> 
						<a href="https://www.youtube.com/watch?v=R5wt7-NO4AM" class="btn"> Mod de preparare </a>
					</td>
					<td class="reteta">
						<a href="https://lecturisiarome.ro/2017/09/ciocolata-de-casa-cu-lapte-praf/" class="btn"> Rețetă </a>
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr >
					<td class="td"></td>
					<td class="td"> Arome </td>
					<td class="td"></td>
					<td class="td"></td>
				</tr>
				<tr> 
					<td> Ciocolată neagră: </td>
					<td> Cacao solidă </td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td></td>
					<td> Lichior de ciocolată </td>
					<td class="reteta"> 
						<a href="https://www.youtube.com/watch?v=YkVi_1GflZc" class="btn"> Mod de preparare </a>
					</td>
					<td class="reteta">
						<a href="http://dolcefarverde.ro/ciocolata-neagra-homemade-fara-zahar-fara-coloranti-fara-conservanti/" class="btn"> Rețetă </a>
					</td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					<td class="td"></td>
					<td class="td"> Vanilie </td>
					<td class="td"></td>
					<td class="td"></td>
				</tr>
				<tr>
					<td> Ciocolată albă: </td>
					<td> Unt de cacao </td>
				</tr>
				<tr>
					<td></td>
				...
				<tr>
					...
					<td> Lapte praf sau condensat </td>
					<td class="reteta"> 
						<a href="https://www.youtube.com/watch?v=Swh8zyQ35WQ" class="btn"> Mod de preparare </a>
					</td>
					<td class="reteta">
						<a href="https://divainbucatarie.ro/2015/08/14/ciocolata-alba-de-casa-2/" class="btn"> Rețetă </a>
					</td>
				</tr>
				<tr>
					<td></td>
...
<html>
	<head>
		<title> Ciocolata </title>
		<link rel="stylesheet" type="text/css" href="style.css">
		<script src="https://kit.fontawesome.com/9a0da22759.js" crossorigin="anonymous"></script>
	</head>
		...
		<header >
			...
			<div class="contact">
				<table cellspacing="15">
					...
					<tr>
						<td class="table-text"> Adresă de email </td>
						<td class="caseta">
							<form class="form-contact">
								<div>
									<input type="email" class="form-control" placeholder="Adresa de email">
								</div>
							</form> 
						</td>
					</tr>
					...
					<tr>
						<td class="table-text"> Telefon </td>
						<td class="caseta">
							<form class="form-contact">
								<div>
				...
				<div class="informatii">
					<div class="follow">
						<i class="fas fa-map-marker-alt"></i> <span> Targu Mures, RO </span>
					</div>
					<div class="follow">
						<i class="fa fa-phone"></i> <span> +4 0730574672 </span>
					</div>
					<div class="follow">
						<i class="fa fa-envelope-o"></i> <span> silvia.bobita@gmail.com </span>
					</div>
				</div>
...
.index
{
	background-image: linear-gradient(rgba(0,0,0,0.5),rgba(0,0,0,0.5)), url(fundal2.jpg);
	height: 100vh;
...
.btn:hover
{
 ...
 .galerie
{
	background-image: radial-gradient(rgba(120,120,120,0.2), rgba(120,120,120,1));
}
